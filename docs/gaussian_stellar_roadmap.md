...
- `stellar-density`
  ...
  - This is still not the final GaussianStellar representation.
- `stellar_worldtube`
...
## What is still missing for true GaussianStellar
...
To call the system "true GaussianStellar", we need all of the following:
...
Build the final GaussianStellar primitive.
