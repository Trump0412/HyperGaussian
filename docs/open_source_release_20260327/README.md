# HyperGaussian Open-Source Release Pack
...
- The common base is `HyperGaussian + external/4DGaussians`; for temporal branches, downstream stages keep consuming the same `run_dir`, `point_cloud`, `temporal_params`, and `entitybank`.
