# GaussianStellar Semantic Pipeline

## Thesis

GaussianStellar should not stop at "better reconstruction with a different temporal prior".
...
GaussianStellar should instead claim:
...
This is the point where GaussianStellar starts affecting semantics structurally rather than cosmetically.
...
2. GaussianStellar turns time into explicit local support in the primitive.
