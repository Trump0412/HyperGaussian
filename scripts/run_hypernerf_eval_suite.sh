...
SOURCE_ROOT="${HYPERNERF_SOURCE_ROOT:-/root/autodl-tmp/data/HyperNeRF/${GROUP}/${SCENE}}"
...
SUBTITLE="${HYPERNERF_SUITE_SUBTITLE:-Baseline vs GaussianStellar worldtube comparison for a local HyperNeRF scene.}"
build_args=(
