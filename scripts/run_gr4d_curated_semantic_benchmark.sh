...
RESULT_ROOT="${2:-/root/autodl-tmp/gaussianstellar_semantic_audit_$(date +%Y%m%d_%H%M%S)}"
...
payload = {
    "americano": "/root/autodl-tmp/GaussianStellar/runs/stellar_worldtube_americano_compare5k/hypernerf/americano",
    "cut-lemon1": "/root/autodl-tmp/GaussianStellar/runs/stellar_worldtube_cut_lemon1_smoke300_v6a/hypernerf/cut-lemon1",
    "split-cookie": "/root/autodl-tmp/GaussianStellar/runs/stellar_tube_split-cookie_smoke300_tubecmp/hypernerf/split-cookie",
    "coffee_martini": "/root/autodl-tmp/GaussianStellar/runs/stellar_tube_coffee_martini_smoke300_tubecmp/dynerf/coffee_martini",
    "flame_steak": "/root/autodl-tmp/GaussianStellar/runs/stellar_tube_flame_steak_smoke300_tubecmp/dynerf/flame_steak",
}
