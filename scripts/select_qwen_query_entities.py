...
from gaussian_stellar.semantics.qwen_query_planner import QwenQueryPlanner, _resolve_qwen_model
from gaussian_stellar.semantics.source_images import resolve_dataset_image_entries, resolve_dataset_time_values


PROMPT_TEMPLATE = """You are selecting candidate aliases from a query-specific GaussianStellar 4D entity library.
